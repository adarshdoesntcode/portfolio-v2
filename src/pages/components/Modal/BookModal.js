...
function BookModal({ book, active }) {
  ...
  return (
    <motion.div
      ...
      className="pointer-events-none fixed  z-50 w-[400px] border  bg-gradient-to-br from-gray-100 to-white p-6 shadow-xl dark:border-gray-800 dark:from-gray-900   dark:to-black "
    >
