    ...
    <div className="col-span-10 border-x px-4 py-5  dark:border-gray-800 sm:px-8 md:col-span-3">
      <div className="relative w-fit">
        <Reveal delay={0.2} duration={1}>
          ...
          <div
            className="absolute right-0 top-0 inline-block -translate-y-1/4 translate-x-full rounded-full bg-green-500 px-4 py-3 font-serif text-sm font-medium  leading-4 tracking-wide  text-black md:-translate-y-0 "
            style={{ opacity: "1" }}
          >
